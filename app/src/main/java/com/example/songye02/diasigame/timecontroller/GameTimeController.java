...
public class GameTimeController extends TimeController {
    ...
    private List<TimerEvent> eventsList;
    ...
    void initTimerEvents() {
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                ...
                FollowTextViewGroup group1 = new FollowTextViewGroup(mHeartShapeView.getBoundaryX() + DpiUtil.dipToPix(30),
                ...
                FollowTextViewGroup group2 = new FollowTextViewGroup(mHeartShapeView.getBoundaryX() + DpiUtil.dipToPix(30),
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                ...
                FollowTextViewGroup group1 = new FollowTextViewGroup(mHeartShapeView.getBoundaryX() + DpiUtil.dipToPix(50),
                ...
                FollowTextViewGroup group2 = new FollowTextViewGroup(mHeartShapeView.getBoundaryX() + DpiUtil.dipToPix(50),
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                    mHeartShapeView, PortraitView portraitView) {
                portraitView.move(portraitView.getCurrentX(), portraitView.getCurrentY(),
                        DiaSiApplication.getPortraitWidth() / 2 - portraitView.getWidth() / 2, portraitView.getCurrentY(), 10);
            }
        });
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                    mHeartShapeView, PortraitView portraitView) {
                portraitView.setPortraitBmp(PortraitView.BMP_LIUXING);
                portraitView.setPositon(DiaSiApplication.getCanvasWidth() / 2 - portraitView.getWidth() / 2, DpiUtil.dipToPix(10));
                mHeartShapeView.setDismiss(false);
                mHeartShapeView.setHeartCenter();
            }
        });
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                    mHeartShapeView, PortraitView portraitView) {
                mMoveables.add(new GunView(DiaSiApplication.getCanvasWidth(), DiaSiApplication
                        .getCanvasHeight(), mHeartShapeView.getBoundaryX() + mHeartShapeView.getBoundaryW() + DpiUtil.dipToPix(50),
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                ...
                mMoveables.add(new GunView(DiaSiApplication.getCanvasWidth() / 2 - DpiUtil.dipToPix(30),
                        DiaSiApplication.getCanvasHeight(), DiaSiApplication.getCanvasWidth() / 2 - DpiUtil.dipToPix(30),
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                    mHeartShapeView, PortraitView portraitView) {
                mMoveables.add(new GunView(mHeartShapeView.getBoundaryX() + mHeartShapeView.getBoundaryW() / 2 - DpiUtil.dipToPix(25),
                        0,
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                ...
                mMoveables.add(new EasyLongSpineGroupView(DiaSiApplication.getCanvasWidth(),
                        ...
                        mHeartShapeView.getBoundaryH() + DpiUtil.dipToPix(20), -mHeartShapeView.getBoundaryW() / 50, 4, 3, 5, 40,
        ...
        eventsList.add(new TimerEvent() {
            ...
            public void addTimerEvent(List<BaseShowableView> mMoveables, HeartShapeView
                ...
                portraitView.move(DiaSiApplication.getCanvasWidth() + portraitView.getWidth(),
                        ...
                        DiaSiApplication.getCanvasWidth() / 2 - portraitView.getWidth() / 2, portraitView.getCurrentY(), 94);
            }
        });
